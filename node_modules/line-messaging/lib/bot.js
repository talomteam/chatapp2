...
function Bot (client, options) {
  ...
  this.getGroupMember = function(groupId) {
    return client.get(endpointBase + '/' + version + '/bot/group/' + encodeURIComponent(userId) + '/members/ids');
  }

  this.getRoomMember = function(groupId) {
    return client.get(endpointBase + '/' + version + '/bot/room/' + encodeURIComponent(userId) + '/rooms/ids');
  }
