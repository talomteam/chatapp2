...
function Bot (client, options) {
  ...
  this.getGroupMember = function(groupId) {
    return client.get(endpointBase + '/' + version + '/bot/group/' + encodeURIComponent(groupId) + '/members/ids');
  }

  this.getRoomMember = function(roomId) {
    return client.get(endpointBase + '/' + version + '/bot/room/' + encodeURIComponent(roomId) + '/rooms/ids');
  }
