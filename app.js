...
mongo.connect('mongodb://127.0.0.1/messaging',function(err,db){
   ...
   bot.on(LINEBot.Events.MESSAGE, function(replyToken, message) {
    ...
    var actions = [
      ...
      var buttonTemplate = new ButtonTemplateBuilder('Evaluation', 'Evaluation for this service', 'https://uxteam.in:4200/image/6a00e0099631d0883301b8d2b85c78970c-800wi.gif', actions);
